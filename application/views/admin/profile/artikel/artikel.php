...
<div class="container-fluid">
    ...
    <form action="<?= base_url('profile/upload_artikel'); ?>" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-icons" style="display: flex; align-items: center; justify-content: center;">
                                                <a href="<?php echo base_url('profile/edit_artikel/' . $a['id_artikel']); ?>" style="color: #3498db; margin-right: 10px;" class="fas fa-edit"></a>
                                                <a href="<?php echo base_url('profile/delete_artikel/' . $a['id_artikel']); ?>" style="color: #e74c3c;" class="fas fa-trash" onclick="return confirm('Apakah Anda yakin ingin menghapus artikel ini?');"></a>
                                            </div>
                                        </td>
                                    </tr>

                                    <!-- Modal Lihat Data -->
                                    <div class="modal fade" id="viewModal<?= $a['id_artikel']; ?>" tabindex="-1" role="dialog" aria-labelledby="viewModalLabel" aria-hidden="true">
