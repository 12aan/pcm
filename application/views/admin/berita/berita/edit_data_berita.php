...
<div class="container-fluid">
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo site_url('berita/edit_data_berita/' . $berita['id_berita']); ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="judul_berita" class="form-label">Judul Berita</label>
                        <input type="text" class="form-control" id="judul_berita" name="judul_berita" value="<?php echo isset($berita['judul_berita']) ? $berita['judul_berita'] : ''; ?>" required>
                    </div>

                    <div class="mb-3">
                        <label for="isi_berita" class="form-label">Isi Berita</label>
                        <textarea id='editor1' class='form-control' name='isi_berita' style='height:1000px' required><?php echo isset($berita['isi_berita']) ? $berita['isi_berita'] : ''; ?></textarea>
