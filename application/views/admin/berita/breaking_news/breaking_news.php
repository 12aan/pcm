...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <a href="<?php echo base_url('berita/tambah_data_breaking_news') ?>" class="btn btn-primary mt-2">Tambah Data</a>
      <div class=" row">
        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          ...
          <tbody>
            ...
            <?php if (!empty($breaking_news)) : ?>
              ...
              ?>
              <?php foreach ($breaking_news as $row) : ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('berita/edit_data_breaking_news/' . $row['id_news']); ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
                    <a href="<?php echo base_url('berita/hapus_data_breaking_news/' . $row['id_news']); ?>" onclick="return confirm('Are you sure you want to delete this item?');" style="color: #e74c3c; "><i class=" fas fa-trash" data-toggle="tooltip" title="Hapus Data"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php else : ?>
