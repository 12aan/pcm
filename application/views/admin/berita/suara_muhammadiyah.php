...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Suara Muhammadiyah</h1>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <a href="<?php echo base_url('suara_muhammadiyah/tambah_data_suara_muhammadiyah') ?>" class="m-0 font-weight-bold text-primary">Tambah Data</a>
    </div>
    <div class="card-body">
