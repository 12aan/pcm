...
<div class="container-fluid">
  ...
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <a href="<?php echo base_url('berita/tambah_data_pengumuman') ?>" class="btn btn-primary mt-2">Tambah Data</a>
      <div class=" row">
              ...
              <?php foreach ($pengumuman as $row) : ?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?php echo base_url('berita/edit_data_pengumuman/' . $row['id_pengumuman']); ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
                    <a href="<?php echo base_url('berita/hapus_data_pengumuman/' . $row['id_pengumuman']); ?>" onclick="return confirm('Are you sure you want to delete this item?');" style="color: #e74c3c; "><i class=" fas fa-trash" data-toggle="tooltip" title="Hapus Data"></i></a>
                  </td>
                </tr>
              <?php endforeach; ?>
            <?php else : ?>
