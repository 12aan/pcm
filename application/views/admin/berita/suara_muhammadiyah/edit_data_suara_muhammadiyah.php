        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Edit Data Suara Muhammadiyah</h4>
                </div>
                <div class="card-body">
                    <form action="<?php echo site_url('berita/edit_data_suara_muhammadiyah/' . $suara_muhammadiyah['id_suara']); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="judul_berita" class="form-label">Judul Berita</label>
                            <input type="text" class="form-control" id="judul_berita" name="judul_berita" value="<?php echo isset($suara_muhammadiyah['judul_berita']) ? $suara_muhammadiyah['judul_berita'] : ''; ?>" required>
                        </div>

                        <div class="mb-3">
                            <label for="isi_content" class="form-label">Isi Berita</label>
                            <textarea id='editor1' class='form-control' name='isi_content' style='height:1000px' required><?php echo isset($suara_muhammadiyah['isi_content']) ? $suara_muhammadiyah['isi_content'] : ''; ?></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="avatar" class="form-label">Avatar Saat Ini</label><br>
                            <?php
                            $avatar = $suara_muhammadiyah['avatar'];
