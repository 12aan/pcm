        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Tambah Data Suara Muhammadiyah</h4>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" action="<?php echo site_url('berita/tambah_data_suara_muhammadiyah'); ?>" method="post">
                        <div class="mb-3">
