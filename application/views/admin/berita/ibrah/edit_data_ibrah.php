    ...
    <body>
        ...
        <section class="section">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo site_url('berita/edit_data_ibrah/' . $ibrah['id_ibrah']); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea id='editor1' class='form-control' name='isi_content' style='height:1000px' required><?php echo isset($ibrah['isi_content']) ? $ibrah['isi_content'] : ''; ?></textarea>
                        </div>
                        <div class="mb-3">
