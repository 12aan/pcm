...
<div class="container-fluid">
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo site_url('berita/edit_data_slider/' . $slider['id_slider']); ?>" method="post" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id='editor1' class='form-control' name='isi_content' style='height:1000px' required><?php echo isset($slider['isi_content']) ? $slider['isi_content'] : ''; ?></textarea>
                    </div>
                    <div class="mb-3">
