          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo base_url('adminor/edit_surat_wakaf') ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
