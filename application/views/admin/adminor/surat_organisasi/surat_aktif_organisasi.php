        ...
        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>Alamat Instansi Kerja</th>
              <th>Telepon Kantor Kerja</th>
              <th>Action</th>
            </tr>
          </thead>
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo base_url('adminor/lihat_data_anggota_organisasi') ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
