...
<div class="container-fluid">
  ...
  <!-- Page Heading -->
  <h1 class="h3 mb-2 text-gray-800">Menu Website</h1>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="<?php echo base_url('menu/edit_data_menu') ?>" style="color: #3498db; margin-right: 10px;"><i class="fas fa-edit" data-toggle="tooltip" title="Edit Data"></i></a>
