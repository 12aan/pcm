		...
		<div class="row">
			<div class="col-lg-9">
				<div class="card">
					...
					<div class="card-body">
						<img src="<?php echo base_url('./uploads/' . $item['avatar']); ?>" alt="Avatar <?php echo $item['id_news']; ?>" class="img-fluid mb-4">
						...
						<div class="mt-4">
							...
							<form action="<?php echo site_url('home/post_breaking_news_comment/' . $item['id_news']); ?>" method="post">
								<div class="mb-3">
