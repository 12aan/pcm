			...
			<div class="col-lg-9">
				<div class="card">
					...
					<div class="card-body">
						...
						<p class="text-muted" style="line-height: 2; text-align: justify;"><?= date('d-m-Y', strtotime($item['tanggal_posting'])); ?></p>
						<div class="card-text">
						...
						<div class="mt-4">
							...
							<form action="<?php echo isset($item['id_konten']) ? site_url('home/post_slider_comment/' . $item['id_konten']) : '#'; ?>" method="post">
								<div class="mb-3">
