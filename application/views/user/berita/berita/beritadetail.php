		...
		<div class="row">
			<div class="col-lg-9">
				<div class="card">
					...
					<div class="card-body">
						<img src="<?php echo base_url('./uploads/' . $item['gambar']); ?>" alt="gambar <?php echo $item['id_konten']; ?>" class="img-fluid mb-4">
						...
						<div class="mt-4">
							...
							<form action="<?php echo isset($item['id_konten']) ? site_url('home/post_berita_comment/' . $item['id_konten']) : '#'; ?>" method="post">
								<div class="mb-3">
